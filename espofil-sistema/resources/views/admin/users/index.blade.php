    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    @role('super', 'manager')
                    <div class="card-header font-mono">Usuários</div>
                    <div class="card-body">
                            ...
                            <table class="table table-sm">
                                ...
                                @foreach($users as $item)
                                    <tr>
                                        ...
                                        <td>
                                        @role('super', 'admin')
                                            <a href="{{ url('/admin/users/' . $item->id) }}" title="View User"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Visualizar</button></a>
